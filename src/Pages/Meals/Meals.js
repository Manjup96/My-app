...
import { faFileExport, faEdit, faTrash, faFilePdf, faTable, faTh } from '@fortawesome/free-solid-svg-icons';
            ...
            <Page style={{ padding: 10 }}>
                <View style={styles.table}>
                    <View style={styles.tableRow}>
                        ...
                        <View style={styles.tableCol}>
                            <Text style={styles.tableCell}>Number of Days</Text>
                        </View>
                        <View style={styles.tableCol}>
                    ...
                    <div key={index} className="col-lg-3 col-md-6 col-sm-6 mb-4">
                        <div className="meal-card p-3">
                            <div className="meal-card-content">
                                ...
                                <br />
                                <strong>Number of Days:</strong> {meal.numberofdays}
                                <br />
